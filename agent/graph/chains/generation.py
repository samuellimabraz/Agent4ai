...
class GenerationChain:
    def __init__(self, model: BaseChatModel, get_chat_history: callable) -> None:
        ...
        Generate the best essay possible for the user's request and the initial outline, with writing excellent 3-4 paragraph essays. \
        ...
        self.generation_chain_with = RunnableWithMessageHistory(
    ...
    def get_chain(self):
        return self.generation_chain_with
